...
/**
 * Data discovery for targeting criterias based on app store categories.
 * 
 * @author Hudson Mendes
 */
public class TargetingCriteriaDiscoveryForAppStoreCategories extends TwitterObject {
    ...
    public TargetingCriteriaDiscoveryForAppStoreCategories(
    	    String name,
    	    String osType,
