...
/**
 * Mixin class for adding Jackson annotations to {@link LineItemPlacements}.
 * @author Hudson Mendes
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public abstract class LineItemPlacementsMixin extends TwitterObjectMixin {
	
	@JsonCreator
	LineItemPlacementsMixin(
			@JsonProperty("placements") List<AdvertisingPlacement> placements,
