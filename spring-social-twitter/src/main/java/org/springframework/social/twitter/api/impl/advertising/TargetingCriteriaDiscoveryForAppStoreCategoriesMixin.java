...
public abstract class TargetingCriteriaDiscoveryForAppStoreCategoriesMixin extends TwitterObjectMixin {

    @JsonCreator
    TargetingCriteriaDiscoveryForAppStoreCategoriesMixin(
