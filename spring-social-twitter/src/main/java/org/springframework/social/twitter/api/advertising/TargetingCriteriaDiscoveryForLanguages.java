...
/**
 * Data discovery for targeting criterias based on languages.
 * 
 * @author Hudson Mendes
 */
public class TargetingCriteriaDiscoveryForLanguages extends TwitterObject {
	private static final long serialVersionUID = 1L;
    private final String name;
    private final String targetingType;
    private final String targetingValue;

    public TargetingCriteriaDiscoveryForLanguages(
    		String name,
