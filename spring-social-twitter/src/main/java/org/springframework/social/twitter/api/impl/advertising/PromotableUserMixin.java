...
public abstract class PromotableUserMixin extends TwitterObjectMixin {

    @JsonCreator
    public PromotableUserMixin(
            @JsonProperty("user_id") Long userId,
            @JsonProperty("id") String id,
            @JsonProperty("account_id") String accountId,
            @JsonProperty("promotable_user_type") String promotableUserType,
