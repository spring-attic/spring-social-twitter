...
/**
 * Data discovery for targeting criterias based on platforms.
 * 
 * @author Hudson Mendes
 */
public class TargetingCriteriaDiscoveryForPlatforms extends TwitterObject {
	private static final long serialVersionUID = 1L;
    private final String name;
    private final String targetingType;
    private final String targetingValue;

    public TargetingCriteriaDiscoveryForPlatforms(
    		String name,
