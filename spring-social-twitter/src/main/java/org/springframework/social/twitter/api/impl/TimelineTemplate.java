...
class TimelineTemplate extends AbstractTwitterOperations implements TimelineOperations {
    ...
    public RelatedResultList getRelated(long tweetId)
    {
        // this method is only available to users who have access to #newtwitter
        // http://api.twitter.com/1/related_results/show/:id
        // http://groups.google.com/group/twitter-api-announce/msg/34909da7c399169e
        requireAuthorization();
        final MultiValueMap<String, String> parameters = new LinkedMultiValueMap<String, String>();
        parameters.putAll(this.buildParameters());
        return restTemplate.getForObject(buildUri("related_results/show/" + tweetId , parameters), RelatedResultList.class);
    }
