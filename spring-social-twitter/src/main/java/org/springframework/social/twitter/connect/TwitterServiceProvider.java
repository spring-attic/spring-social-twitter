...
public class TwitterServiceProvider extends AbstractOAuth1ServiceProvider<Twitter> {
    ...
    private String hostForStandardApi;
    private String hostForAdsApi;
    ...
    public TwitterServiceProvider(
        ...
        this.hostForStandardApi = hostForStandardApi;
        this.hostForAdsApi = hostForAdsApi;
    }
